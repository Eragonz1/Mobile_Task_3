...
public class MainActivity extends AppCompatActivity {
    ...
    private void addStudent() {
        ...
        try {
            ...
            values.put(DatabaseHelper.COLUMN_FIRST_NAME, "Золотарев");
            values.put(DatabaseHelper.COLUMN_LAST_NAME, "Даниил");
            values.put(DatabaseHelper.COLUMN_MIDDLE_NAME, "Николаевич");
            values.put(DatabaseHelper.COLUMN_DATE, "2024-11-19");
